...
import java.util.Scanner;
	...
	public class StudentManagementSystem {
		...
		public void insertStudent(int rollNo , String sname,Date dob,float percentage,String city,String email_id,String phone_no) throws SQLException {
		...
		public void updateStudent(int rollNo , String sname,Date dob,float percentage,String city,String email_id,String phone_no) throws SQLException {
		...
		public static void main(String[] args) throws ClassNotFoundException, SQLException {
			...
			System.out.println("1.add Student record (use stored procedure)\r\n"
			...
			case 1:
				 	obj.insertStudent(101, "Ramesh", "2001-2-4", 67.77f,"Mumbai","ramesh123@mail.com","986886868");
			...
			case 5:
				obj.searchStudentByPercentage(ch, ch);
				break;
			case 6:
				obj.topper();
				break;
			case 7:
				obj.serachStudentById(ch);
				break;
		...
		private void insertStudent(int rollNo, String sname, String string, float percentage, String city,
				String email_id, String phone_no) {
